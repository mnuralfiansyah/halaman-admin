...
{ 
	 if ((!empty($_POST['name'])) and (!empty($_POST['email'])) and (!empty($_POST['password'])) and (!empty($_POST['password'])))
	 {
		register($_POST['name'],$_POST['email'],$_POST['password'],$_POST['repassword']);
	 }
	 else
	 {
?> 
...
<head>
    ...
    <title>daftar | <?php echo judul(); ?></title>
    <!-- Favicon-->
...
<body class="signup-page">
    <div class="signup-box">
        ...
        <div class="card">
            <div class="body">
                <form id="sign_up" method="POST" action="registrasi.php">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="password" class="form-control" name="repassword" minlength="4" placeholder="Confirm Password" required>
                        </div>
                    </div>
